			...
			<tbody> 
				<?php while($data=mysql_fetch_object($q)){ ?> 
					<tr <?php if($data->status == "pending" ){ echo 'style="background:#cce9f8 !important;"'; } ?> > 
						...
						<td>
							<a class="btn btn-sm btn-warning" href="pembayaran.php?act=detail&id=<?php echo $data->id ?>">Bukti</a>
							<a class="btn btn-sm btn-info" href="detail_pesanan.php?id=<?php echo $data->id_pesanan ?>">Detail</a>
